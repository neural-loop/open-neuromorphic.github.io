...
sections:
  - title: "Neuromorphic Hardware Guide"
    url: "/neuromorphic-computing/hardware/" # <<< CHANGED: Explicit full path
    description: "Listing of neuromorphic hardware"
    icon_name: "microchip" # Assuming you want an icon
    icon_style: "solid"    # Assuming you want an icon
    # column: "col-6" # This is not used by the updated card layout
    subsections: # These are not rendered directly on the top-level card anymore
      - title: "Learn"
        description: "Find specifications, papers, and development status"
  - title: "Neuromorphic Software Guide"
    url: "/neuromorphic-computing/software/" # <<< CHANGED: Explicit full path
    description: "Collection of neuromorphic software"
    icon_name: "code" # Assuming you want an icon
    icon_style: "solid"   # Assuming you want an icon
    # column: "col-6" # This is not used by the updated card layout
    subsections: # These are not rendered directly on the top-level card anymore
      - title: "Learn"
